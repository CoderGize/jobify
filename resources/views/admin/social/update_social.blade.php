                                    ...
                                    <tbody>
                                        <form action="{{ url('/admin/update_social_confirm', $social->id) }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center m-auto">
                                                        <select class="w-50 form-select" disabled>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="">
                                                        <input type="text" name="mail" value="{{ $social->mail }}"
                                                            class="form-control">
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <i class="bi bi-dribbble fs-4" style="color: #ea7d24"></i>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        Dribble
                                            ...
                                            <tr>
                                                <td>
                                                    <i class="bi bi-threads text-dark fs-4"></i>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        Threads
                                            ...
                                            <tr>
                                                <td>
                                                    <i class="bi bi-twitter-x fs-4" style="color: #000000 "></i>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        Twitter
                                            ...
                                            <tr>
                                                <td>
                                                    <i class="bi bi-medium text-black fs-4"></i>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        Medium
                                            ...
                                            <tr>
                                                <td>
                                                    <i class="bi bi-behance fs-4" style="color:#053eff"></i>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        Behance
